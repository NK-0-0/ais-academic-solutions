    ...
    <div className="container mx-auto px-4">
      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-muted-foreground leading-relaxed">
          With over 6 years of tutoring experience, Gen founded AIS to create a safe space for students to learn, grow, and achieve academic excellence. The mission is to make quality education accessible and to support students holistically — academically, emotionally, and spiritually.
        </p>
      </div>
    </div>
  </section>
